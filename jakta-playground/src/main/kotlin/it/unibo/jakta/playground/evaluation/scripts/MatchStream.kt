...
class LogEventsStreamProcessor : CliktCommand() {
    ...
    override fun run(): Unit =
        runBlocking {
            ...
            val logger = NarrativeGenerationLogger.of("StreamProcessor", loggingConfig)
